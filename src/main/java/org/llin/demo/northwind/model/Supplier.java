...
public class Supplier extends EntityObject implements _Classes_EntityObject {
	...
	private void csvToArray() {
		...
		String csvIds = links.getLink("product").getId();
		...
		Product[] array = {};
		products.setProducts(list.toArray(array));
	}
	...
	public String toString() {
		return "Supplier [lastName=" + lastName + ", firstName=" + firstName + ", emailAddress=" + emailAddress
				...
				+ ", company=" + company + ", products=" + products + super.toString() + "]";
	}
