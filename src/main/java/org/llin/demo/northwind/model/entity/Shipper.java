...
public class Shipper extends EntityObject implements _Classes_EntityObject {
	...
	public String toString() {
		return "Shipper [company=" + company + ", lastName=" + lastName + ", firstName=" + firstName
				...
				+ portraitPath + ", portraitTitle=" + portraitTitle + super.toString() + "]";
	}
