...
public class Employee extends BaseObject {
	...
	public void setNotes(String notes) {
		this.notes = StringUtil.addEllipsis(notes);		
	}
	...
	public String toString() {
		return "\nEmployee [lastName=" + lastName + ", firstName=" + firstName + ", emailAddress=" + emailAddress
				...
				+ ", countryRegion=" + countryRegion + ", notes=" + notes + ", webSiteUrl=" + webSiteUrl
				+ ", webSiteTitle=" + webSiteTitle + ", portraitPath=" + portraitPath + ", portraitTitle="
				+ portraitTitle + ", company=" + company + ", privilege=" + privilege + super.toString() + "]";
	}
