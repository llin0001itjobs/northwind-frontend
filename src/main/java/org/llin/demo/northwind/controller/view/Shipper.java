...
public class Shipper extends BaseObject {
	...
	public String toString() {
		return "\nShipper [lastName=" + lastName + ", firstName=" + firstName + ", emailAddress=" + emailAddress
				...
				+ portraitTitle + ", company=" + company + super.toString() + "]";
	}
