...
import org.llin.demo.northwind.cache.type.RootPathType;
...
@Component
public class Json2BaseObject<T extends EntityObject> implements _JsonKeys, _Values {
	...
	public T[] getObjects(String typeName, String jsonText)
		...
		Class<T[]> type = baseObjectCacheType.getMapOfBaseType().get(typeName);
	...
	public static void main(String[] args) {
		...
		String idParam = "id=";
		Json2BaseObject jo = new Json2BaseObject();
